    ...
    return (
        <>
            ...
            <section className="landing-page">
                <span className="text-white big-text mb-2">Sign up and manage <br /> your balance</span>
                <span className="text-white small-text mb-3">Note down your expenditure and income, then check your <br /> balance everyday</span>
                ...
                <form action="#">
                    ...
                    <button className="mt-2" type='button' onClick={onSubmit}>
